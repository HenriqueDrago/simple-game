...
function Header({ game, handleStart, handleReset, handleWhoStartsChange }) {
    ...
    else if (battleState === turnStatus.DEFEAT) announcement = "Player Two Wins!";
    else if (battleState === turnStatus.DRAW) announcement = "Draw!";
    else if (battleState !== turnStatus.SETUP) announcement = `Turn ${game.turnCount}`;
        ...
        <div className="header-container">
            ...
            <div className="header-button-container">
                {battleState === turnStatus.SETUP && (
                    <button className="sharp-btn" onClick={handleStart}>Start</button>
                )}
                <button className="sharp-btn" onClick={handleReset}>Reset</button>
                ...
                {battleState === turnStatus.SETUP && (
                    <div className="who-starts-select-container">
                        ...
                        <select
                            ...
                            value={whoStarts}
                            onChange={(e) => handleWhoStartsChange(e.target.value)}
                        >
                            <option value={whoStartsKeys.PLAYER_ONE}>Player One</option>
                            <option value={whoStartsKeys.PLAYER_TWO}>Player Two</option>
